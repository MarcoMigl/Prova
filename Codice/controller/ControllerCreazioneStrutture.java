...
public class ControllerCreazioneStrutture {
   ...
   public void creazioneUtente(BeanUtenti bean) throws Exception,SQLException, CampiVuotiException, EmailNonValidaException{
      ...
      if(type.isEmpty() || nome.isEmpty() || cognome.isEmpty() || email.isEmpty()|| citta.isEmpty()|| password.isEmpty()){
        throw new CampiVuotiException("Dati mancanti, inserire i dati in tutti i campi");
      ...
      try{
        ...
        if(utente == null){
            throw new Exception("Creazione utente fallita");
        }
